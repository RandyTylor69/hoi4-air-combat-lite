public class Main {
    ...
    public static void main(String[] args) {
        ...
        Fighter spitfire = new Fighter();
        Fighter zero = new Fighter();
        Combat combat = new Combat(spitfire,zero, 5000, 5000);
        ...
        zero.setWeapon("4xHMG");
        zero.setWeapon("4xLMG");
        zero.setArmor("Armor Plate");
        zero.setFuelTank("Extra Fuel Tanks");
